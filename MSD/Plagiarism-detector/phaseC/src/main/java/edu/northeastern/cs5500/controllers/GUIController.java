...
public class GUIController {
    ...
    @ResponseBody
    public ResponseEntity<String> login(HttpServletRequest request, HttpServletResponse response, ModelMap map, @RequestParam("pwd") String pwd, @RequestParam("uname") String uname) throws ClassNotFoundException {
    	uSERNAME = uname;
    ...
    @ResponseBody
    public ResponseEntity<String> register(@RequestParam("cred") String pwd, @RequestParam("uname") String uname, @RequestParam("email") String email) throws SQLException {
